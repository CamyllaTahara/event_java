...
public class TelaEvento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Convidado:");

        jLabel8.setText("Email:");

        jLabel9.setText("WhatsApp");

        jLabel10.setText("Número Participantes:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                Eventobuilder eb = new Eventobuilder();
                eb.setEvento(jTextField1.getText());
                eb.setDia(jTextField2.getText());
                eb.setHorario(jTextField3.getText());
                eb.setArea(jTextField4.getText());
                eb.setLocalevento(jTextField5.getText());
                eb.setConvidado(jTextField6.getText());
                eb.setEmail(jTextField7.getText());
                eb.setWhatsapp(jTextField8.getText());
                eb.setParticipantes(Integer.parseInt(jTextField9.getText()));
                Evento ev = eb.constroi();
                
                jframefacade jf = new jframefacade();
                String texto = null;
        try {
            texto = jf.Cadastrar(ev);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         Eventobuilder eb = new Eventobuilder();
           eb.setId(Integer.parseInt(jTextField10.getText()));
           Evento ev = eb.constroi();
           jframefacade jf = new jframefacade();
                String texto = null;
        try {
